          ...
          {statuses &&
            statuses?.map((data) => (
              <p
                ...
                className={`px-4 py-2 rounded-md text-xl text-textColor font-semibold cursor-pointer hover:shadow-md border border-gray-200 backdrop-blur-md ${
          ...
          {isLoading ? (
            ...
            <>
              {!imageDownloadURL ? (
                <>
                  <label>
                    <div className="flex flex-col items-center justify-center h-full w0full cursor-pointer">
                    <div className="flex flex-col items-center justify-center h-full w0full cursor-pointer">
                        <p className='font-bold text-4xl'>
                            <FaCloudUploadAlt className="-rotate-0"/>
                        </p>
                        <p className='text-lg text-textColor'>Click to upload image</p>
                        </div>
                    </div>
                    <input 
                    type='file'
